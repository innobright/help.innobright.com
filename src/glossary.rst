...
.. note:
    ...
    Please order by non-abbreviated words. Include abbrevation as a secondary term (e.g. see "arbitrary output vector"/AOV). Don't include an abbreviation unless it's expansion is obvious (e.g. VFX → visual effects(
